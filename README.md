...
Comentar que se espera la entrada por serial de un JSON de tal forma que contenga:        
{"id": id_paciente,"p":peso,"c":caudal,"v_total":volumen_total,"q_max":caudal_max,"estado":estado_proceso}.
...
El botón se conectará en el D2.    
Sensor HX711 en el D0 (DT) - D1 (SCK).   
